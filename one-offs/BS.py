...
"METASPLOIT ACTIVATED",
"CRYPTOGRAPHIC ANALYSIS INITATED",
"DECRYPTING",
"TRACEBACK ROUTE FOUND",
"TRACEROUTE FOLLOWING",
"VPN CONNECTION ESTABLISHED",
"CREATING BOTNET",
"CPU POOLING CHAIN FOMED",
"PROXY CHAIN INITIALIZED"] #using an array so as to make this a single file
